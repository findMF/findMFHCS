...
ExternalProject_Add(
    glog
    GIT_REPOSITORY https://github.com/emzeat/google-glog.git
    #GIT_REVISION -r 139
    TIMEOUT 10
...
set(Glog_SourceDir ${source_dir}/include)

ExternalProject_Get_Property(glog binary_dir)
IF(CMAKE_BUILD_TYPE STREQUAL "Debug")
    set(Glog_LIBRARY ${binary_dir}/DebugLibs)
ELSE(CMAKE_BUILD_TYPE STREQUAL "Debug")
    set(Glog_LIBRARY ${binary_dir}/ReleaseLibs)
