...
namespace ralab{
  ...
  public:
    ...
    void extractFeatures(FeaturesMap & features, const Gradient & gradient){
  ...
  private:
    ...
    static void createFeaturesFromStatistics( FeaturesMap & features ,
    ...
    void extractFeaturesI( const Gradient & data , FeaturesMap & mf )
    {
