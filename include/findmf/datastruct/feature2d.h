...
namespace ralab{
  ...
  public:
    ...
    ralab::projectionstats & getRTStats() {
      rtstats_.computeStats(rtprojection_ , minRTIndex_ );
      return rtstats_;
    }

    //calls an mz peak finder behind the scenes
    ralab::projectionstats & getMZStats() {
      mzstats_.computeStats(mzprojection_ , minMZIndex_ );
      return mzstats_;
    }
  };//end
