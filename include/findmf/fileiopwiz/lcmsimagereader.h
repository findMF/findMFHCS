...
namespace ralab{
  ...
  */
  ...
  private:
    ...
    typedef boost::shared_ptr<ralab::LCMSImage> LCMSImagePtr;
    ralab::SwathInfoPtr swathInfo_; // holds the swath information
    std::vector<int> idx_;
  ...
  public:
   ...
   LCMSImageReader(std::string & filename,
    ...
    //returns ms1 map
    void getMS1Map( LCMSImage & image ){
    ...
    /// Store file on disk
    void write(const std::string & filenameOut, ralab::LCMSImage & mmap){
